 ...
 */
@Generated("")
@GraphQLName("BatchPlanMapping")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BatchPlanMapping")
public class BatchPlanMapping implements Serializable {

	public static BatchPlanMapping toDTO(String json) {
		return ObjectMapperUtil.readValue(BatchPlanMapping.class, json);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof BatchPlanMapping)) {
			return false;
		}

		BatchPlanMapping batchPlanMapping = (BatchPlanMapping)object;

		return Objects.equals(toString(), batchPlanMapping.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.admin.batch.planner.dto.v1_0.BatchPlanMapping",
		name = "x-class-name"
	)
