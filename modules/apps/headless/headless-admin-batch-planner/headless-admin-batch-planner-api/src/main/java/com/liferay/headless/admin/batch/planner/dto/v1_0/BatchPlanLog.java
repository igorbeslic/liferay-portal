 ...
 */
@Generated("")
@GraphQLName("BatchPlanLog")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "BatchPlanLog")
public class BatchPlanLog implements Serializable {

	public static BatchPlanLog toDTO(String json) {
		return ObjectMapperUtil.readValue(BatchPlanLog.class, json);
	}
	...
	@JsonIgnore
	public void setBatchPlanId(
		UnsafeSupplier<Long, Exception> batchPlanIdUnsafeSupplier) {

		try {
			batchPlanId = batchPlanIdUnsafeSupplier.get();
		}
	...
	@Schema(description = "The batch plan log's ID.")
	public Long getId() {
		return id;
	}
	...
	@GraphQLField(description = "The batch plan log's ID.")
	@JsonProperty(access = JsonProperty.Access.READ_WRITE)
	protected Long id;
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof BatchPlanLog)) {
			return false;
		}

		BatchPlanLog batchPlanLog = (BatchPlanLog)object;

		return Objects.equals(toString(), batchPlanLog.toString());
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.headless.admin.batch.planner.dto.v1_0.BatchPlanLog",
		name = "x-class-name"
	)
