...
@Component(
	...
	service = {DTOConverter.class, LogDTOConverter.class}
)
public class LogDTOConverter implements DTOConverter<BatchPlannerLog, Log> {
	...
	@Override
	public Log toDTO(BatchPlannerLog batchPlannerLog) throws Exception {
		return new Log() {
			{
	...
	public List<Log> toDTOs(List<BatchPlannerLog> batchPlannerLogs)
		throws Exception {

		List<Log> logs = new ArrayList<>();

		for (BatchPlannerLog batchPlannerLog : batchPlannerLogs) {
			logs.add(toDTO(batchPlannerLog));
		}
