<%@ page import="com.liferay.batch.planner.constants.BatchPlannerConstants" %>
<%@ include file="/init.jsp" %>

<%
	Subscription subscription = subscriptionLocalService.fetchSubscription(user.getCompanyId(), user.getUserId(), BatchPlannerAdminPortlet.class.getName(), 0);
...
<h2>Batch Planner Import Notification Subscription</h2>
