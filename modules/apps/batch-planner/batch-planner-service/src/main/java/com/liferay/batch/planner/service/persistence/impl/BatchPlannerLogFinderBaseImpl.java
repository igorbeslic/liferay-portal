 ...
 * @generated
 */
public abstract class BatchPlannerLogFinderBaseImpl
	extends BasePersistenceImpl<BatchPlannerLog> {

	public BatchPlannerLogFinderBaseImpl() {
	...
	public Set<String> getBadColumnNames() {
		return batchPlannerLogPersistence.getBadColumnNames();
	}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BatchPlannerLogFinderBaseImpl.class);
