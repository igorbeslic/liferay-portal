...
public class BatchPlannerLogPersistenceImpl
	...
	/**
	 * Returns all the batch planner logs that the user has permission to view where batchPlannerPlanId = &#63;.
	 *
	 * @param batchPlannerPlanId the batch planner plan ID
	 * @return the matching batch planner logs that the user has permission to view
	 */
	@Override
	public List<BatchPlannerLog> filterFindByBatchPlannerPlanId(
		long batchPlannerPlanId) {

		return filterFindByBatchPlannerPlanId(
			batchPlannerPlanId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the batch planner logs that the user has permission to view where batchPlannerPlanId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>BatchPlannerLogModelImpl</code>.
	 * </p>
	...
	public List<BatchPlannerLog> filterFindByBatchPlannerPlanId(
		...
		return filterFindByBatchPlannerPlanId(
			batchPlannerPlanId, start, end, null);
	}

	/**
	 * Returns an ordered range of all the batch planner logs that the user has permissions to view where batchPlannerPlanId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>BatchPlannerLogModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns the batch planner logs before and after the current batch planner log in the ordered set of batch planner logs that the user has permission to view where batchPlannerPlanId = &#63;.
	 *
	 * @param batchPlannerLogId the primary key of the current batch planner log
	 * @param batchPlannerPlanId the batch planner plan ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public BatchPlannerLog[] filterFindByBatchPlannerPlanId_PrevAndNext(
			long batchPlannerLogId, long batchPlannerPlanId,
			OrderByComparator<BatchPlannerLog> orderByComparator)
		throws NoSuchLogException {

		if (!InlineSQLHelperUtil.isEnabled()) {
			return findByBatchPlannerPlanId_PrevAndNext(
		...
		try {
			...
			array[0] = filterGetByBatchPlannerPlanId_PrevAndNext(
				session, batchPlannerLog, batchPlannerPlanId, orderByComparator,
				true);

			array[1] = batchPlannerLog;

			array[2] = filterGetByBatchPlannerPlanId_PrevAndNext(
				session, batchPlannerLog, batchPlannerPlanId, orderByComparator,
				false);
	...
	protected BatchPlannerLog filterGetByBatchPlannerPlanId_PrevAndNext(
		Session session, BatchPlannerLog batchPlannerLog,
		long batchPlannerPlanId,
		OrderByComparator<BatchPlannerLog> orderByComparator,
		boolean previous) {
	...
	/**
	 * Returns the number of batch planner logs that the user has permission to view where batchPlannerPlanId = &#63;.
	 *
	 * @param batchPlannerPlanId the batch planner plan ID
	 * @return the number of matching batch planner logs that the user has permission to view
	 */
	@Override
	public int filterCountByBatchPlannerPlanId(long batchPlannerPlanId) {
		if (!InlineSQLHelperUtil.isEnabled()) {
			return countByBatchPlannerPlanId(batchPlannerPlanId);
		}
