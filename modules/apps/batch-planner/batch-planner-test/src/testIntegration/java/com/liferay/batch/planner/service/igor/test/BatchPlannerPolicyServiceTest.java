...
package com.liferay.batch.planner.service.igor.test;
	...
	public void testBatchPlannerPolicyPermissions() throws Exception {
		List<BatchPlannerPolicy> batchPlannerPolicies =
			BatchPlannerPolicyTestUtil.addBatchPlannerPolicy(
				"policy_1", "policy_1_value", "policy_2", "policy_2_value",
				"policy_3", "policy_3_value", "policy_4", "policy_4_value",
				"policy_5", "policy_5_value");
