...
public class BatchPlannerLogUtil {
	 ...
	 * @return the matching batch planner logs that the user has permission to view
	 */
	public static List<BatchPlannerLog> filterFindByBatchPlannerPlanId(
		long batchPlannerPlanId) {

		return getPersistence().filterFindByBatchPlannerPlanId(
			batchPlannerPlanId);
	}
	 ...
	 * @throws NoSuchLogException if a batch planner log with the primary key could not be found
	 */
	public static BatchPlannerLog[] filterFindByBatchPlannerPlanId_PrevAndNext(
			long batchPlannerLogId, long batchPlannerPlanId,
			OrderByComparator<BatchPlannerLog> orderByComparator)
		throws com.liferay.batch.planner.exception.NoSuchLogException {

		return getPersistence().filterFindByBatchPlannerPlanId_PrevAndNext(
			batchPlannerLogId, batchPlannerPlanId, orderByComparator);
	}
	 ...
	 * @return the number of matching batch planner logs that the user has permission to view
	 */
	public static int filterCountByBatchPlannerPlanId(long batchPlannerPlanId) {
		return getPersistence().filterCountByBatchPlannerPlanId(
			batchPlannerPlanId);
	}
